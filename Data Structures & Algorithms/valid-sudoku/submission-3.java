class Solution {
    ...
    public boolean isValidSudoku(char[][] board) {
        ...
        for(int i = 0; i < board.length; i+=3) {
            for(int j = 0; j < board[0].length; j+=3) {
                if(!helperGrid(board, i, j)) return false;
            }
        }
    ...
    // private boolean helperRow1(char[][] board, int row) {
    //     // for row we should not have repeat values from 1 to 9
    //     HashSet<Character> hs = new HashSet<>();
    //     for(int j = 0; j < 9; j++) {
    //         char ch = board[row][j];
    ...
    // private boolean helperCol1(char[][] board, int col) {
    //     // for col we should not have repeat values from 1 to 9
    //     HashSet<Character> hs = new HashSet<>();
    //     for(int i = 0; i < 9; i++) {
    //         char ch = board[i][col];
    ...
    // private boolean helperGrid1(char[][] board, int row, int col) {
    //     // for 3X3 grid we should not have repeat values from 1 to 9
    //     HashSet<Character> hs = new HashSet<>();
    //     for(int i = row; i < row+3; i++) {
    //         for(int j = col; j < col+3; j++) {
